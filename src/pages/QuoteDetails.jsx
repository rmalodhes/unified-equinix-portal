...
const QuoteDetails = () => {
  ...
  const handleCreateOrder = () => {
    if (!currentQuote || selectedItems.size === 0) return;
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl p-12 text-center shadow-sm">
            ...
            <div className="text-gray-500 text-xl mb-4">Quote not found</div>
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-gray-800 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Quote Items with Stepper */}
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
              <div className="p-6 border-b border-gray-200">
                <h2 className="text-xl font-semibold text-gray-900">
                  Quote Items ({currentQuote.items.length})
                </h2>
                <p className="text-gray-600 text-sm mt-1">
                  Select items to include in order
                </p>
              </div>
                ...
                <div className="space-y-4">
                  {currentQuote.items.map((item, index) => (
                    <div key={index} className="relative">
                      {/* Stepper Line */}
                      {index < currentQuote.items.length - 1 && (
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6 pb-4 border-b border-gray-200">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">{currentQuote.id}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                ...
                <div className="mt-4 p-3 bg-green-50 rounded-lg">
                  <p className="text-xs text-green-700">
                    <strong>Ready to Order:</strong> All pricing has been
